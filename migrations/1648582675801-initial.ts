...
export class initial1648582675801 implements MigrationInterface {
    name = 'initial1648582675801'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."payment_status_enum" AS ENUM('CREATED', 'APPROVED', 'SCHEDULED', 'REJECTED')`);
        await queryRunner.query(`CREATE TABLE "payment" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "external_id" character varying NOT NULL, "status" "public"."payment_status_enum" NOT NULL, "amount" integer, "expected_on" date NOT NULL, CONSTRAINT "PK_fcaec7df5adf9cac408c686b2ab" PRIMARY KEY ("id"))`);
